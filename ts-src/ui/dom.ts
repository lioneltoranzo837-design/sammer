...
export const nostrConnectAvatar = getElementById<HTMLImageElement>('nostr-connect-avatar');
export const nostrConnectLabel = getElementById<HTMLSpanElement>('nostr-connect-label');
